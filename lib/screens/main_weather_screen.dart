...
import 'package:myweather/components/weather_item.dart';
...
class _MainWeatherScreenState extends State<MainWeatherScreen> {
  ...
  static String API = 'b4c951c889a44d41939121903242006';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      height: 160,
                      child: Center(child: Image.asset("assests/" + weatherIcon)),
                    ),
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      child: Row(
                        ...
                        children: [
                          WeatherItem(
                            ...
                            unit: 'km/h',
                            imageUrl: 'assests/windspeed.png',
                          ),
                          WeatherItem(
                            value: humidity.toInt(),
                            unit: '%',
                            imageUrl: 'assests/humidity.png',
                          ),
                          WeatherItem(
                            value: cloud.toInt(),
                            unit: '%',
